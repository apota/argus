...
- Devs who want to quickly toggle across multiple AWS accounts and environments (production, dev, test) to query the AWS landscaape. All that pointing & clicking on AWS console can slow you down and frankly give you carpal tunnel syndrome (CTS)!
